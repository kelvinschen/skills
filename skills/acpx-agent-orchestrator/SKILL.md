...
- For completed or partially completed lanes, inspect the summary output and `<handoffRoot>/flow-memory.md` before opening node handoff files or session tails.
